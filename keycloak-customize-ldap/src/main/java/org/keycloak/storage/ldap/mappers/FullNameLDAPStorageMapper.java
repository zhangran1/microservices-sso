        ...
        if (ldapProvider.getEditMode() == UserStorageProvider.EditMode.WRITABLE && !isReadOnly()) {
            ...
            TxAwareLDAPUserModelDelegate txDelegate = new TxAwareLDAPUserModelDelegate(delegate, ldapProvider, ldapUser) {
                ...
                public Map<String, List<String>> getAttributes() {
                    ...
                    if (firstName != null) {
                        attributes.put(FIRST_NAME, Collections.singletonList(firstName));
                    } else if (lastName != null) {
                        attributes.put(FIRST_NAME, Collections.singletonList(lastName));
                    }
                    return attributes;
                }
                ...
                private void setFullNameToLDAPObject() {
                    ...
                    markUpdatedAttributeInTransaction(FIRST_NAME);
                    markUpdatedAttributeInTransaction(LAST_NAME);
