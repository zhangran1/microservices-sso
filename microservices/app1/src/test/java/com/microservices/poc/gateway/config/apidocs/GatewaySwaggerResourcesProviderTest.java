package com.microservices.poc.gateway.config.apidocs;

import static com.microservices.poc.gateway.config.apidocs.GatewaySwaggerResourcesProvider.swaggerResource;
