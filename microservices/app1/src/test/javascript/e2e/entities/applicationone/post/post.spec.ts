...
describe('Post e2e test', () => {
  ...
  it('should load Posts', async () => {
    ...
    expect(await postComponentsPage.getTitle()).to.eq('gatewayApp.applicationonePost.home.title');
  ...
  it('should load create Post page', async () => {
    ...
    expect(await postUpdatePage.getPageTitle()).to.eq('gatewayApp.applicationonePost.home.createOrEditLabel');
  ...
  it('should create and save Posts', async () => {
    ...
    await promise.all([
      ...
      postUpdatePage.applicationoneSelectLastOption(),
  ...
  it('should delete last Post', async () => {
    ...
    expect(await postDeleteDialog.getDialogTitle()).to.eq('gatewayApp.applicationonePost.delete.question');
