...
public class Post implements Serializable {
    ...
    public Appone getApplicationone() {
        return this.applicationone;
    }

    public Post applicationone(Appone appone) {
        this.setApplicationone(appone);
        return this;
    }

    public void setApplicationone(Appone appone) {
        this.applicationone = appone;
    }
